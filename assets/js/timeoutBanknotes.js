...
$(function() {
	...
	var $htmlPopup = '<div id="moretimeModal" class="kiosko-modal popup-exit modal-timeout kiosko-modal-w-560 kiosko-modal-h-360" style="display:none;"> <header></header> <div class="content h-264 kiosko-modal-padding-top"> <p class="title vertical-middle"> <span>Tiempo de inactividad superado</span></p> <p class="subtitle vertical-middle kiosko-modal-margin-bottom-40 kiosko-modal-margin-top-32  "> Si sales, retira los billetes de la ranura, <br/ >¿Quieres continuar? </p></div><footer class="modal-buttons kiosko-modal-h-56"> <buttom id="timeout_close-session" class="continue-session btnBack kiosko-modal-bottom-57 left-45-force">No, salir </buttom> <buttom id="timeout_continue-session" class="btnCloseSession kiosko-modal-bottom-57 right-45-force"> Sí, continuar</buttom></footer></div>';
